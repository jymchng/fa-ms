...
export class SchemesController {
  ...
  @ApiOperation({
    ...
    description:
      'Returns a list of all schemes with their eligibility status for the specified applicant',
  })
  @ApiQuery({
    name: 'applicantId',
    required: true,
  ...
  async findEligible(
    ...
    const schemes = await this.schemesService.findEligibleSchemes(
      query.applicantId,
    );
    return schemes;
  }
